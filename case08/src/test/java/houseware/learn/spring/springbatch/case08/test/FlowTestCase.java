package houseware.learn.spring.springbatch.case08.test;

import houseware.learn.spring.springbatch.base.TestCaseBase;
import houseware.learn.spring.springbatch.case08.BatchService;
import houseware.learn.spring.springbatch.case08.ImportMetadata;
import houseware.learn.spring.springbatch.case08.ImportMetadataHolder;
 ...
 */
@ContextConfiguration(locations = "classpath:houseware/learn/spring/springbatch/case08/test/test-context.xml")
